...
class RestartViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.timeLimit = RestartViewController.startTimeLimit - abs(RestartViewController.timeDurationInBackground)
     
        self.timeLimitSendAgain = RestartViewController.startTimeLimitSendAgain2 - abs(RestartViewController.timeDurationInBackground2)
   ...
   @objc func appCameToForeground() {
    ...
    func gameStart() { 
        ...
        RestartViewController.startTimeLimit = self.timeLimit

        backgroundStartDate2 = Date()
        RestartViewController.startTimeLimitSendAgain2 = self.timeLimitSendAgain
    }
    ...
    func gameEnd() {
        ...
        RestartViewController.timeDurationInBackground = Int(numberOfSecondInBackground)
  
        let numberOfSecondInBackground2 = round(backgroundStartDate2.timeIntervalSinceNow)
        RestartViewController.timeDurationInBackground2 = Int(numberOfSecondInBackground2)
